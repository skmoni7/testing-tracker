        ...
        <div className="bg-white rounded-2xl shadow-md p-8 w-full max-w-sm">
          ...
          {resetSent ? (
            <div className="text-center">
              <p className="text-green-600 font-semibold mb-4">Reset email sent!</p>
              <p className="text-gray-500 text-sm mb-6">Check your inbox at <strong>{email}</strong> and follow the link to reset your password.</p>
              <button
